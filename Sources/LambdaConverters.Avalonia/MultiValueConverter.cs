...
namespace LambdaConverters
{
    ...
    {
        abstract class Converter : LambdaConverters.Converter, IMultiValueConverter, IExtendedMultiValueConverter
        {
            protected Converter(
            ...
            protected abstract object? ConvertInternal(IList<object?> values, object? parameter, CultureInfo? culture);
        ...
        sealed class Converter<I, O> : Converter
        {
            ...
            protected override object? ConvertInternal(IList<object?> values, object? parameter, CultureInfo? culture)
            {
                if (parameter != null)
                {
                ...
                var inputValues = new I[values.Count];
